<%@ Page Title="" Language="C#" MasterPageFile="~/Master.Master" AutoEventWireup="true" CodeBehind="PokemonLista.aspx.cs" Inherits="pokedex_web_nivel3.PokemonLista" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="row">
        ...
        <div class="col-6" style="display:flex; flex-direction: column; justify-content: flex-end;" >
            <div class="mb-3">
                <asp:CheckBox Text="Filtro Avanzado" ID="chkFiltroAvanzado" OnCheckedChanged="chkFiltroAvanzado_CheckedChanged" CssClass="form-check" AutoPostBack="true" runat="server" />
            </div>
        </div>
    </div>
    ...
    <asp:GridView ID="dgvPokemons" runat="server" CssClass="table" AutoGenerateColumns="false"
        ...
        <Columns>
            ...
            <asp:CommandField HeaderText="Acción" ShowSelectButton="true" SelectText="✍︎" />
        </Columns>
    </asp:GridView>
